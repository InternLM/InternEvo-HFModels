...
MODEL_ONLY_FOLDER = "/home/ubuntu/tangzhiyi/ckpt/Baichuan"
SAVE_CKPT_FOLDER = "/home/ubuntu/tangzhiyi/ckpt/Baichuan"
...
ckpt = dict(
    ...
    async_upload=True,
    async_upload_tmp_folder="/home/ubuntu/tangzhiyi/ckpt/Baichuan",
...
data = dict(
    type="streaming",
    tokenizer_path="/home/ubuntu/tangzhiyi/models/Baichuan2-7B-Base",
    seq_len=SEQ_LEN,
    micro_num=4,
    micro_bsz=1,
    valid_micro_num=4,
